...
import { BASE_URL_IMAGE, getUsersAPI } from '../utils/fetchFromAPI';
    ...
    return <div>
        ...
        <div className="chat-popup" id="formChat">
            ...
            <ol className="discussion" id="chat-noiDung">
                ...
                {dataChat.map(item => {
                    return <li className={`${item.user_id == users.userId ? "self" : "other"}`}>
            ...
            <div className="chatBottom">
                ...
                <button id="btn-send" onClick={() => {
                    ...
                    socket.emit("send-message", {content: message, user_id: users.userId, roomId})
        ...
        <div style={{ width: drawer }} className='sidenav'>
            ...
            {user.map(item => {
                ...
                return <a href="#" onClick={() => {
                    ...
                    let roomId = item.user_id > users.userId ? `${users.userId}-${item.user_id}` : `${item.user_id}-${users.userId}`
