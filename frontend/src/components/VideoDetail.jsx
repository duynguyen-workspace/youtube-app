...
import { commentAPI, getVideoByIdAPI, getVideoCommentsAPI } from "../utils/fetchFromAPI";
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <a
                                            href="#!"
                                            className=" text-white rounded-end p-2 border"
                                        >
                                            ...
                                            <div className="float-end mt-2 pt-1">
                                                <button
                                                    ...
                                                    onClick={(e) => {
                                                        ...
                                                        let txtComment = document.getElementById("comment").value
                                                        ...
                                                        commentAPI(commentModel).then(result => {
                                                            console.log(result)
                                                            
                                                            getVideoCommentsAPI(id).then(res => setComments(res.data)).catch()
                                        ...
                                        >
                                            {comments &&
                                                comments.map((comment) => {
                                                    return (
                                                        <div className="d-flex flex-start" key={comment.comment_id}>
                                                            <img
                                                                className="rounded-circle shadow-1-strong me-3"
                                                                src={
                                                                    comment.user
